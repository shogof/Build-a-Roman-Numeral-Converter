...
1. **Clone the repository:**
   ```bash
   git clone git@github.com:shogof/Build-a-Roman-Numeral-Converter.git
   ```
...
2. **Navigate to project directory:**
   ```bash
   cd Build-a-Roman-Numeral-Converter
   ```
...
2.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Shegofa/Build-a-Roman-Numeral-Converter.git
    ```
